...
lm(reclamacoes_l$erro ~ reclamacoes_l$lexico.dummy)
lm1 = lm(reclamacoes_op30$erro ~ reclamacoes_op30$polaridade_normalizada)
lm2 = lm(reclamacoes_sent$erro ~ reclamacoes_sent$polaridade_normalizada)
